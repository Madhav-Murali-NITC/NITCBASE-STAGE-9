...
int Algebra::select(char srcRel[ATTR_SIZE], char targetRel[ATTR_SIZE], char attr[ATTR_SIZE], int op, char strVal[ATTR_SIZE]) {
    ...
    */
    ...
    int succheck=SUCCESS;

    while (succheck == SUCCESS) {

        Attribute currAttrs[src_nAttrs];
        succheck = BlockAccess::search(srcRelId, currAttrs, attr, attrVal, op);
        // ret = BlockAccess::insert(targetRelId, record);
        int ret = BlockAccess::insert(targetRelId, currAttrs);
        // if (insert fails) {
...
int Algebra::project(char srcRel[ATTR_SIZE], char targetRel[ATTR_SIZE], int tar_nAttrs, char tar_Attrs[][ATTR_SIZE]) {
    ...
    */
   //CHECK THE FOR LOOP CONDITIONS IF NOT WORKING===================================
